...
export function PageSilabas() {
  const letras: Letra[] = [
    ...
    { familia: "P",  l: "PO", texto: "Pó de porco", imagem:"" },
    { familia: "P",  l: "PU", texto: "Pú de pulga", imagem:"" },
    ...
    { familia: "R",  l: "RU", texto: "Rú de Rute", imagem:"" },
    ...
    { familia: "Z",  l: "ZA", texto: "Zá de zangão", imagem:"" },
    { familia: "Z",  l: "ZE", texto: "Zê de zebra", imagem:"./letras/Zebra.png" },
    { familia: "Z",  l: "ZI", texto: "Zí de zico", imagem:"" },
    { familia: "Z",  l: "ZO", texto: "Zó de zorro", imagem:"" },
    { familia: "Z",  l: "ZU", texto: "Zú de zumbi", imagem:"" },
  ];
