...
export function PageSilabas() {
  const letras: Letra[] = [
    ...
    { familia: "S",  l: "SU", texto: "Su de suco", imagem:"./silabas/Suco.png" },
    ...
    { familia: "V",  l: "VU", texto: "Vú de vulcao", imagem:"./silabas/Vulcao.png" },
    {familia: "W",  l: "WA", texto: "Uá...ou...Wá de ually", imagem:"./silabas/Wally.png" },
    { familia: "W",  l: "WE", texto: "Ué...ou...Wê de úéb", imagem:"./silabas/Web.png" },
    { familia: "W",  l: "WI", texto: "Uái...ou...Uí...ou...Wí de UaiFai", imagem:"./letras/Wifi.png" },
    { familia: "W",  l: "WO", texto: "Uó de uorque", imagem:"./silabas/Wok.png" },
    { familia: "W",  l: "WU", texto: "Uú de Wudson", imagem:"./silabas/Wushu.png" },
