...
export function PageSilabas() {
  const letras: Letra[] = [
    ...
    {familia: "W",  l: "WA", texto: "Uá...ou...Wá de wally", imagem:"./silabas/Wally.png" },
    { familia: "W",  l: "WE", texto: "Ué...ou...Wê de uéb", imagem:"./silabas/Web.png" },
    { familia: "W",  l: "WI", texto: "Uái...ou...Uí...ou...Wí de wifi", imagem:"./letras/Wifi.png" },
