...
export function PageSilabas() {
  const letras: Letra[] = [
    ...
    { familia: "W",  l: "WE", texto: "Ue ou Wê de web", imagem:"./silabas/Web.png" },
    { familia: "W",  l: "WI", texto: "Uái ou Uí ou Wí de wifi", imagem:"./letras/Wifi.png" },
    { familia: "W",  l: "WO", texto: "Uó de work", imagem:"./silabas/Wok.png" },
    { familia: "W",  l: "WU", texto: "ú de Wudson", imagem:"./silabas/Wushu.png" },
